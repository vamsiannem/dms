...
<div style="padding-left: 15px;padding-top: 4px;float:left;">
    <div style="float:left;width: 450px;height: 250px;border: 2px solid #fff; cursor:pointer;" id="list_of_networks">
	NetworkStatus
    </div>&nbsp;
    <div style="float:right;width: 450px;height: 250px;border: 2px solid #fff; cursor:pointer;" id="monthly_reports">
	Monthly Reports
    </div>   
</div>

<div style="padding-top: 10px;float:left;padding-right: 100px;padding-left: 15px;">
    <div style="float:left;width: 450px;height: 250px;border: 2px solid #fff; cursor:pointer;" id="recent_projects">
	Recent Projects
    </div>&nbsp;
     <div style="float:right;width: 450px;height: 250px;border: 2px solid #fff; cursor:pointer;" id="user_activities">
	User Activities
    </div> 
</div>
</div>
