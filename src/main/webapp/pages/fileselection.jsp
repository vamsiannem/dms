...
<div style="padding-left: 15px;padding-top: 4px;float:left;">
    <div style="float:left;width: 600px;height: 350px;border: 2px solid #fff;">
	File Selection
	<span style="float:right;padding-top:300px "><input type="submit" name="submit" value="Import" class="button" />
