...
<div style="padding-left: 15px;padding-top: 4px;float:left;">
    <div style="float:left;width: 780px;height: 350px;border: 2px solid #fff;">
	NetworkStatus
    </div>&nbsp;
    <div style="float:right;width: 250px;height: 173px;border: 2px solid #fff">
	Monthly Reports
    </div><br>&nbsp;
    <div style="float:right;width: 250px;height: 172px;border: 2px solid #fff">
	User Activities
    </div> 
</div>
...
<div style="padding-top: 10px;float:right;padding-right: 100px;padding-left: 15px;">
 <span style="float:right;padding-top:0px ">
 <input type="submit" name="submit" value="Trending" class="button" />
   
 <input type="submit" name="submit" value="Reports" class="button" />
 
 <input type="submit" name="submit" value="Fault prediction" class="button" /></span><br>   
</div>
<div class="footer1">
