...
*/
	...
	*/
	...
	function showHideNode(e,inputId)
	{
		...
		if(thisNode.style && thisNode.style.visibility && thisNode.style.visibility=='hidden')return;
		if(thisNode.style && thisNode.style.display && thisNode.style.display=='none')return;
